...
var fileDescriptor_e0c0e45ee319d513 = []byte{
	...
	0x19, 0xfc, 0x8e, 0x5a, 0x51, 0xdd, 0x72, 0x42, 0x78, 0x07, 0xfe, 0x03, 0x17, 0xe6, 0x7e, 0x5f,
	0xed, 0x62, 0xb0, 0x1e, 0x8c, 0x3e, 0x3f, 0x1f, 0xe8, 0xa1, 0x5c, 0x78, 0xb2, 0x71, 0xe4, 0xa1,
	0x6e, 0x7f, 0x02, 0x00, 0x00, 0xff, 0xff, 0x52, 0xae, 0x5f, 0xaa, 0xb8, 0x01, 0x00, 0x00,
}
...
type VesselServiceClient interface {
	FinsAvailable(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error)
}
...
func (c *vesselServiceClient) FinsAvailable(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.serviceName, "VesselService.FinsAvailable", in)
	out := new(Response)
...
type VesselServiceHandler interface {
	FinsAvailable(context.Context, *Specification, *Response) error
}
...
func (h *VesselService) FinsAvailable(ctx context.Context, in *Specification, out *Response) error {
	return h.VesselServiceHandler.FinsAvailable(ctx, in, out)
}
